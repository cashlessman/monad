    ...
    (
      ...
      <div tw="flex items-center justify-center text-white">
            ...
            <div tw="flex flex-col">
              ...
              <span tw="flex text-xl">@{username}</span>            </div>
       </div>
       ...
       <span tw="flex mt-3 text-2xl">{(( Number(Number(lfid)-Number(fid)) / Number((lfid)))*100).toFixed(1)}% users joined after {username}</span>
       </div>
